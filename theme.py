...
ICON_PATHS = {
    ...
    "idea": '<path d="M9 18h6M10 22h4"/><path d="M8.5 15.5C6.9 14.4 6 12.5 6 10.5a6 6 0 1 1 12 0c0 2-.9 3.9-2.5 5-.7.5-1 1.1-1 1.5h-5c0-.4-.3-1-1-1.5Z"/><path d="M12 3V1M4.9 4.2 3.5 2.8M19.1 4.2l1.4-1.4M4 10H2M22 10h-2"/>',
